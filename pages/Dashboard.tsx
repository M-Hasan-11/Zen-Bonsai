      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="lg:col-span-3 space-y-6">
          <div className="bg-surface-dark rounded-xl p-6 border border-[#2f3231] flex flex-col items-center text-center">
            ...
            <h2 className="text-xl font-bold text-white">Elena Fisher</h2>
          ...
          <nav className="bg-surface-dark rounded-xl p-4 border border-[#2f3231]">
            <ul className="space-y-1">
              ...
              <li><button className="w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:text-red-300 hover:bg-red-900/10 rounded-lg font-medium transition-colors font-body text-sm text-left">Sign Out</button></li>
            </ul>
          </nav>
        </aside>
        ...
        <div className="lg:col-span-9 space-y-8">
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">Welcome back, Elena</h2>
