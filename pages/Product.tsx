        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              {[...Array(4)].map((_, i) => (
                <button key={i} aria-label={`View product image ${i + 1}`} className={`relative aspect-square rounded-lg overflow-hidden border-2 ${i === 0 ? 'border-primary' : 'border-transparent hover:border-white/50 opacity-70 hover:opacity-100'} transition-all`}>
