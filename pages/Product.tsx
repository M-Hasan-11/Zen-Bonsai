        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
          ...
          <div className="flex flex-col py-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button onClick={() => navigate('/cart')} className="flex-1 h-14 bg-primary hover:bg-primary-hover text-white font-bold text-lg rounded-lg shadow-lg shadow-primary/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="w-full lg:w-96">
                        <div className="bg-surface-dark border border-[#2f3231] rounded-xl p-6">
                            ...
                            <div className="flex justify-between text-text-muted mb-2 text-sm"><span>Subtotal</span><span>$0.00</span></div>
                            <div className="flex justify-between text-text-muted mb-4 text-sm"><span>Shipping</span><span>Calculated at checkout</span></div>
                            <div className="border-t border-[#2f3231] pt-4 flex justify-between text-white font-bold text-lg mb-6"><span>Total</span><span>$0.00</span></div>
                            <button className="w-full py-3 bg-[#2f3231] text-text-muted font-bold rounded-lg cursor-not-allowed">Checkout</button>
                        </div>
                    </div>
                </div>
             </div>
